...
func mapDnd5eMonsterToJsonBody(m *db.Dnd5eMonster) *api.Dnd5eMonsterGet {
	ret := &api.Dnd5eMonsterGet{
		Dnd5eMonster: api.Dnd5eMonster{
			...
			CharismaScore:        SMaybeInt32(m.ChaScore),
			ConstitutionScore:    SMaybeInt32(m.ConScore),
			Description:          SMaybeString(m.Description),
			DexterityScore:       SMaybeInt32(m.DexScore),
			Environments:         &m.Environments,
			HitPoints:            SMaybeInt32(m.HitPoints),
			IntelligenceScore:    SMaybeInt32(m.IntScore),
			...
			Sources:              &m.Sources,
			StrengthScore:        SMaybeInt32(m.StrScore),
			Unique:               &m.IsUnique,
			UserTags:             m.UserTags,
			WisdomScore:          SMaybeInt32(m.WisScore),
		},
...
func dnd5eMonsterCreate(b *BardView5Http, body *api.PostApiV1Dnd5eSettingsDnd5eSettingIdMonstersJSONBody, dnd5eSettingId int64) (int64, error) {
	...
	changedRows, err := b.Querier().Dnd5eMonsterInsert(b.Context, db.Dnd5eMonsterInsertParams{
		...
		StrScore:             MaybeInt(body.StrengthScore),
		IntScore:             MaybeInt(body.IntelligenceScore),
		WisScore:             MaybeInt(body.WisdomScore),
		DexScore:             MaybeInt(body.DexterityScore),
		ConScore:             MaybeInt(body.ConstitutionScore),
		ChaScore:             MaybeInt(body.CharismaScore),
	})
	if err != nil {
