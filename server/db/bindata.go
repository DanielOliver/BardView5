...
// ../migrations/0_init.up.sql (8.641kB)
...
func _0_initUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0_init.up.sql", size: 8641, mode: os.FileMode(0666), modTime: time.Unix(1635655142, 0)}
